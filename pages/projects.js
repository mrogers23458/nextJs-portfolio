...
import projectImage3 from "../public/images/cleanapp-hero.png"
    ...
    return (
        <div className="projects-box">
            <div className="projects-header">
                ...
                <h2 className="projects-header-sub-text">Here are some of the projects that highlight a few of technologies Ive been using. </h2>
            </div>
